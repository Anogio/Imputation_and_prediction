...
\begin{titlingpage}
	...
	\HRule \\[0.4cm]
	{ \huge \bfseries Missing data imputation for Hemorrhagic shock prediction}\\[0.4cm] % Title of your document
	\HRule \\[1.5cm]
	...
	\includegraphics[scale=1.2]{Resources/Stats_Logo}\\[1cm] % Include a department/university logo - this will require the graphicx package
	%----------------------------------------------------------------------------------------
