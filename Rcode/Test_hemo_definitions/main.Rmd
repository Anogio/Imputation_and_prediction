...
print('Correlation with overalll mortality')
...
traumdata %>%
  dplyr::select(arrivalMonth,c1,c3,c4,c5) %>%
  ...
  xlim(c(2010,NA)) + xlab('Year (one point per month)') + ylab('Number of patients matching criterion this month')
```
