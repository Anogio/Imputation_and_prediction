...
oneRun = function(args){
  ...
  y.gen = y.trauma
  predictor = reg.logit
 errFun = function(y.pred,y.true){metric_best_separation_fixedThr(y.pred,y.true, positive_weighting=pos.weight,threshold = 0.1)$val}
 # errFun = AUC
...
```{r}
S = 4
argsL = list(train_prop=0.7, pos.weight=1:10)
