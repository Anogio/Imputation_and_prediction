...
X_train_miss = impute(X_train_miss, method='MF')[[1]]
X_test_miss = impute(X_test_miss, method='MF')[[1]]
```
```{r}
...
for(i in 1:n_imputations){
  ...
  predictions.multi = cbind(predictions.multi, rowMeans(as.data.frame(predictions.multi.linear)))
}
predictions$multi.linear = rowMeans(as.data.frame(predictions.multi.linear))
predictions$multi.rf = rowMeans(as.data.frame(predictions.multi.rf))
```
